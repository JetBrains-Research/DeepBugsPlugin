...
class DownloadTask(project: Project?, message: String, canBeCancelled: Boolean,
    ...
    override fun onThrowable(error: Throwable) {
        DeepBugsNotifier.notifyWithAction(DeepBugsPythonBundle.message("notification.title"), DeepBugsPluginServicesBundle.message("error.notification.message"),
    ...
    override fun onCancel() {
        DeepBugsNotifier.notifyWithAction(DeepBugsPythonBundle.message("notification.title"), DeepBugsPluginServicesBundle.message("cancel.notification.message"),
