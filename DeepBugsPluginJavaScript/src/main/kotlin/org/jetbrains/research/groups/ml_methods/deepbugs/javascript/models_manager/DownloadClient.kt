...
object DownloadClient {
    ...
    fun checkRepos() {
        when (client.modelFilesExists()) {
            ...
            false -> DeepBugsNotifier.notifyWithAction(DeepBugsJSBundle.message("notification.title"), DeepBugsPluginServicesBundle.message("download.notification.message"),
    ...
    fun downloadAndInitModels() {
        val downloadTask = DownloadTask(ProjectManager.getInstance().defaultProject,
                DeepBugsJSBundle.message("download.task.title"), true, client::download)
