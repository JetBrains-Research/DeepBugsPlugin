...
class JSDeepBugsSwappedArgsInspection : JSDeepBugsCallExprInspection() {
    override val keyMessage = "javascript.swapped.args.inspection.warning"
    ...
    override fun getDisplayName() = DeepBugsJSBundle.message("javascript.swapped.args.inspection.display")
    override fun getShortName(): String = DeepBugsJSBundle.message("javascript.swapped.args.inspection.short.name")
}