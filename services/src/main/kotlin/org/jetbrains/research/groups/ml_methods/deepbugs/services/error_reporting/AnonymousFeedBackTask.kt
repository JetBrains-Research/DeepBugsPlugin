 ...
 */
class AnonymousFeedbackTask internal constructor(project: Project?,
        title: String,
        canBeCancelled: Boolean,
        private val errorReportInformation: ErrorReportInformation,
        private val myCallback: Consumer<SubmittedReportInfo>) : Backgroundable(project, title, canBeCancelled) {
